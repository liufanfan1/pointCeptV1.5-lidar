...
# Stage 2 local tower-ROI fine segmentation.
#
# Input dataset:
#   data/transmission_line_stage2_tower
#
# Stage-2 classes:
#   0 tower
#   1 insulator
...
model = dict(
    ...
    criteria=[
        dict(
            ...
            # tower / insulator / hengdan / background
            # Insulator is usually the rarest, so give it the largest weight.
            weight=[2.0, 20.0, 6.0, 0.3],
            loss_weight=1.0,
            ignore_index=-1,
        ),
        dict(
...
data_root = "data/transmission_line_stage2_tower"
ignore_index = -1
names = ["tower", "insulator", "hengdan", "background"]
